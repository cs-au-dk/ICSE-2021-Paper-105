...
export class StaticConfiguration {
  ...
  public static patcherPreparingDir = resolve(StaticConfiguration.outPath, 'patcherPreparingDir');
  public static patcherRunningDir = resolve(StaticConfiguration.outPath, 'patcherRunningDir');
